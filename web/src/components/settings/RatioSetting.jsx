...
import TokenTierPricingSettings from '../../pages/Setting/Ratio/TokenTierPricingSettings';
    ...
    <Spin spinning={loading} size='large'>
      ...
      <Card style={{ marginTop: '10px' }}>
        <Tabs type='card'>
          ...
          <Tabs.TabPane tab={t('分段计费设置')} itemKey='token_tier'>
            <TokenTierPricingSettings options={inputs} refresh={onRefresh} />
          </Tabs.TabPane>
        </Tabs>
      </Card>
    </Spin>
